...
# P.S. Понимаю, что среда разработки другая, но из-за кол-ва символов (126>120) PyCharm ругалась. Разделил в 2 строки.
# P.P.S. Вcе равно строки в комментариях =)
...
x, g = 3, 8
# P.S. Здесь не совсем понимаю ошибку. Но переименовал переменную 'y' на 'g', т.к. в задаче  был пункт переименовать
# переменные названные не в соответствии со стилем кода
if x == 3:
    print(42)
...
if o > 0:
    print()
# P.S Заменил переменные на другие буквы l = r, t = I, O = o(Понимаю, что указано как пример), т.к. ошибки раздражали
